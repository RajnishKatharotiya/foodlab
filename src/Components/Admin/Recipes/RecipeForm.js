...
export const RecipeForm = ({ show, handleClose, initialValue }) => {
  ...
  return (
    ...
    >
      {({
        ...
        <Modal show={!!show} onHide={handleClose} className="recipe-form_body"  backdrop="static" keyboard={false}>
          <Form noValidate onSubmit={handleSubmit}>
            <Modal.Body>
              <h4>{typeof show === 'boolean' ? 'Add New Recipe' : `Edit Recipe #${show}`}</h4>
              <Row>
